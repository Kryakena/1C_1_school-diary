# 📚 Создание информационной базы "Дневник", создание динамического элемента "Планировщик" 📚
...
![2025-04-02_15-05-11](https://github.com/user-attachments/assets/37acb640-c4e6-4ca0-b059-879280506b47)



https://github.com/user-attachments/assets/b35720e1-0408-4dc1-859f-9721b5da4b3f
...
- доработки "Планировщика"

1. убираем надпись "Планировщик" слева над расписанием, т.к. есть заголовок

![2025-03-26_12-21-12](https://github.com/user-attachments/assets/960f68e2-8a7f-4847-a0b6-82b5e746f6ea)

- два раза щелкаем по "Планировщик" ("Общие" -- "Общие Формы")
- в разделе "Форма" -- правой кнопкой по "Планировщик" в подразделе "Элементы" --"Свойства"

![2025-03-26_12-26-22](https://github.com/user-attachments/assets/92af53f6-0502-49f1-8cf3-d45d598b22d4)

- "Положение заголовка" -- в выпадающем списке выбрать "Нет"

![2025-03-26_12-29-01](https://github.com/user-attachments/assets/4b04dec2-7f36-4ebc-b6ce-48c6b609adc7)

2. убираем кнопку "Еще" в "Планировщике" - она нам не нужна

- два раза щелкаем по "Планировщик" ("Общие" -- "Общие Формы")
- в разделе "Форма" -- правой кнопкой по кнопке "Еще" в разделе предпросмотра --"Свойства"
- снять галочку в "Автозаполнение"

![2025-03-26_12-32-47](https://github.com/user-attachments/assets/98ee29dc-64c0-49aa-9594-aabc895be767)

![2025-03-26_12-36-01](https://github.com/user-attachments/assets/719830b3-924c-4caf-b386-db46292c4df3)

3. делаем заполнение заголовков ручным в "Планировщике" - неделя будет отображаться в виде даты

- два раза щелкаем по "Планировщик" ("Общие" -- "Общие Формы")
- в разделе "Форма" -- правой кнопкой по "Форма" в подразделе "Элементы" --"Свойства"
- снять галочку в "АвтоЗаголовок"

![2025-03-26_12-38-40](https://github.com/user-attachments/assets/dbad30f1-8a47-42a5-b86a-9b5b9cc6ca63)

- добавляем строку кода в процедуру "ПриСозданииНаСервере" - чтобы создать в первый раз, когда форма создается, при открытии формы на сервере.

```bsl
Заголовок = "Расписание занятий " + ПредставлениеПериода(НачалоПериода, КонецПериода);
```

![2025-03-26_12-59-42](https://github.com/user-attachments/assets/f69825ff-f565-4959-8c70-738bdc5d0427)


- добавляем такую же строку в процедуру "ПриСменеТекущегоПериодаОтображения"

```bsl
Заголовок = "Расписание занятий " + ПредставлениеПериода(НачалоПериода, КонецПериода);
```

![2025-03-26_13-00-15](https://github.com/user-attachments/assets/03ea170d-c445-43ae-bc37-064e0e950f90)

![2025-03-26_13-01-02](https://github.com/user-attachments/assets/e387bf47-c4d7-45b1-a0a6-7528f4df7b17)


# "Дневник" - часть 17

- красивое и удобное расписание в "Планировщике"

 1. для будущих уроков делаем рамку и закрасим их в белый цвет

- добавляем конструкцию "Если" в процедуре "ЗаполнитьПланировщикНаСервере()" - она будет анализировать, где находится дата начала урока: в прошлом или будущем.
...
![2025-03-26_13-58-53](https://github.com/user-attachments/assets/f9e43758-9f4e-44fe-8d26-d50863c59a7c)


- в эту конструкцию "Если" вставляем оформление для будущих занятий
...
![2025-03-26_14-17-38](https://github.com/user-attachments/assets/914384a6-f29b-4d7e-9b1a-ef4b0cccb017)

![2025-03-26_14-18-25](https://github.com/user-attachments/assets/15209034-bed0-46bd-8e04-f23a20f67ffc)


2. отображение оценок в "Планировщике" - изменяем текст запроса, чтобы получить оценку

- в процедуре "ЗаполнитьПланировщикНаСервере()" добавить строку

```bsl
|	УчебныйДеньУроки.Оценка КАК Оценка
```

![2025-03-26_19-49-56](https://github.com/user-attachments/assets/beed6232-7da7-44ff-a664-3c9e75a652bb)


3.  отображение цвета оценок в "Планировщике"
   
- пример: 
	- оценка "5" - закрасить зеленым цветом
	- оценка "3" - закрасить красным цветом
...
![2025-03-26_21-06-52](https://github.com/user-attachments/assets/a3f0e968-6c06-4bec-a258-a605ff7203a1)

- в инструкции "Если" используем вызов этой функции
...
![2025-03-26_21-10-46](https://github.com/user-attachments/assets/4b6c2ef3-c374-4d5e-88dd-bf9f8d6b504a)

![2025-03-26_21-11-45](https://github.com/user-attachments/assets/74a804d9-d720-4ed7-afa9-0da9fb3d73b6)

4. какое домашнее задание выполнено, а какое - нет.

- нужны поля "ДомашнееЗадание" и "Выполнено" - добавляем 2 строки в запрос
...
![2025-03-27_15-35-16](https://github.com/user-attachments/assets/fff5a205-8d4c-4c76-9338-09b39b99130f)

- есть ли вообще домашнее задание, выполнено ли? В виде выделения цветом. Добавляем функцию
...
Функция ЦветДомашнегоЗадания(Есть, Выполнено)
	...
	Иначе
		Возврат WebЦвета.Белый; // нет домашнего цвета
...
![2025-03-27_16-10-48](https://github.com/user-attachments/assets/218d761f-7eb4-4e05-8135-e9a84f1f2376)

- функция будет использоваться там, где устанавливается цвет фона для будущего урока. Добавляем строку "ЕстьЗадание" в процедуру "ЗаполнитьПланировщикНаСервере()" и переписываем строку "НовыйЭлемент.ЦветФона"
...
![2025-03-27_16-15-38](https://github.com/user-attachments/assets/f0d64b2d-7f20-4dea-8b5c-1811c5e68925)

- добавляем содержание домашнего задания в "Планировщик", если оно есть. Дописываем строку "НовыйЭлемент.Текст" в процедуре "ЗаполнитьПланировщикНаСервере()".
- ПС - перевод строки. Чтобы название предмета было на отдельной строке и не "сливалось" с названием предмета.

```bsl
НовыйЭлемент.Текст = Выборка.Предмет + Символы.ПС + Выборка.ДомашнееЗадание;
```

![2025-03-27_16-20-10](https://github.com/user-attachments/assets/7a9f966f-c1b1-4fd6-8312-1e2c8b871e12)

![2025-03-27_16-24-26](https://github.com/user-attachments/assets/d301608f-b0e9-4667-962f-ee10c5ecf32c)


# "Дневник" - часть 18

- чтобы изменения в "Дневник" автоматически обновлялись в "Планировщик" (сейчас он обновляет свои данные 1 раз, в момент создания формы)
- механизм оповещения работает только на клиенте, поэтому используем клиентское событие "ПослеЗаписи"
- "Документы" -- правой кнопкой по "УчебныйДень" -- "Открыть модуль объекта"
- ввести оповещение
...
![2025-03-28_13-09-26](https://github.com/user-attachments/assets/c7b66cfc-991d-45ba-b8df-b7f4e4d9dbd8)

- чтобы форма "услышала" данное оповещение - создаем обработчик события "ОбработкаОповещения"
- "Общие" -- "Общие формы" -- дважды щелкаем по "Планировщик" -- раздел "Модуль" --пишем обработчик события
...
![2025-03-28_12-50-34](https://github.com/user-attachments/assets/16d3b7bf-65c5-47d0-877a-792c5765e6b8)

- обновить данные планировщика - удаляем старые данные и снова заполняем его -- добавляем 2 строки в обработчик события "ОбработкаОповещения"
...
![2025-03-28_12-52-59](https://github.com/user-attachments/assets/b029fc07-3e26-46eb-bafe-0c57ee5a88f5)


# "Дневник" - часть 19

- создаем простой инструмент: поможет не пропустить домашнее задание

1. "Регистры сведений" -- раскрываем список "ДомашниеЗадания" -- дважды по нему щелкаем и выбираем подраздел "Формы" -- нажимаем плюсик "Добавить" --кнопка "Готово"

![2025-03-28_13-35-00](https://github.com/user-attachments/assets/d1536e46-7edd-4ca0-b8c0-fdb595cbc3f8)

- удаляем ненужные поля - "Период", "Регистратор", "НомерСтроки", "Выполнено"

![2025-03-28_13-39-54](https://github.com/user-attachments/assets/ca6c6003-ed5b-42d3-a911-9ce39ed05670)

2. настройка внешнего вида списка: 

- правой кнопкой по основному реквизиту "Список" -- "Свойства"

![2025-03-28_13-43-51](https://github.com/user-attachments/assets/4e9648b8-fc90-4805-8ba2-14a18ac61bf4)

- в подразделе "Настройка списка" -- нажать "Открыть"

![2025-03-28_13-47-31](https://github.com/user-attachments/assets/468812b9-b081-411c-87d5-e964c4640e56)

- перейти во вкладку "Порядок" и перетащить "Период" и "НомерСтроки" из поля "Доступные поля" в поле для пользователя

![2025-03-28_13-49-46](https://github.com/user-attachments/assets/549a2a78-e71e-4ba3-a643-83426226eb0d)

- перейти во вкладку "Группировка" и перетащить "Период" из поля "Доступные поля" в поле для пользователя

![2025-03-28_13-51-37](https://github.com/user-attachments/assets/9ccc4af8-fcbf-4652-beff-ae711a44ea40)

- нажать "ОК"

3. чтобы увидеть эту форму в командном интерфейсе нужно включить команду перехода к ней

- правой кнопкой по "Дневник" -- "Открыть командный интерфейс основного раздела"

![2025-03-28_13-56-28](https://github.com/user-attachments/assets/1806517c-e9de-4868-b520-5382c8d93ade)

- поставить галочку в "Домашние задания" -- кнопка "ОК"

![2025-03-28_13-58-26](https://github.com/user-attachments/assets/78e0dd00-ec92-45b4-a2e1-0f6004992f8f)

4. результат:

![2025-03-28_13-59-51](https://github.com/user-attachments/assets/0a940614-b396-4a3a-9b6e-156eb6981d72)

5. цветное оформление

- "Регистры сведений" -- "ДомашниеЗадания" -- "Формы" -- дважды щелкнуть по "ФормаСписка" -- правой кнопкой по "Список" -- "Свойства" -- в строке "Настройка списка" нажать "Открыть"

![2025-03-28_14-02-41](https://github.com/user-attachments/assets/bcd311f1-334a-45ab-a110-c682c8c6d853)

- перейти во вкладку "Условное оформление" 

![2025-03-28_14-06-06](https://github.com/user-attachments/assets/7bbfe53f-f442-4a29-ab34-e07de2adbf9a)

- будущее оформление состоит из 3х частей:
	- Оформление - визуальный эффект, который должен быть использован. 
	- Условие - условие, при выполнении которого визуальный эффект должен быть применен
	- Оформляемые поля - те поля, к которым вы хотите применить оформление

- нажать плюсик "Добавить" -- многоточие в строке добавленного оформления "..." -- многоточие "..." в строке "Цвет фона" --- вкладка "Web" -- "Серебристо-серый" -- кнопка "ОК"

![2025-03-28_14-10-24](https://github.com/user-attachments/assets/9a071653-2d0c-40a2-a6af-3bb674924f42)

- еще раз кнопка "ОК" - закрываем окно "Редактирование параметров"

![2025-03-28_14-13-47](https://github.com/user-attachments/assets/2b78d324-6b07-4dc3-897a-cf5d5f59795c)

- переходим во вкладку "Отбор" -- нажимаем кнопку с выпадающим списком

![2025-03-28_14-15-24](https://github.com/user-attachments/assets/6f5d9075-7979-44a8-a819-52183cc92e18)

- выбираем "Новый элемент"

![2025-03-28_14-15-50](https://github.com/user-attachments/assets/1a245231-c4ba-4231-a384-a5bc457f017a)

- в поле "Левое значение" -- нажать "..." и выбрать "Выполнено" -- кнопка "ОК"

![2025-03-28_14-17-36](https://github.com/user-attachments/assets/8f9f74cd-0529-460b-a02c-51ff1d45b79b)

- в поле "Правое значение" -- нажать "..." и выбрать "Истина" -- кнопка "ОК"

![2025-03-28_14-18-12](https://github.com/user-attachments/assets/800b64cb-77da-4dfb-9a57-936c34951064)

6. результат

https://github.com/user-attachments/assets/8bb2c9e8-9f2c-446d-bc6e-1a5673ae5dde

7. делаем так, чтобы отбор можно было быстро включать и выключать прямо в режиме "1С:Предприятие" - сначала задаем представление

- "Регистры сведений" -- "ДомашниеЗадания" -- "Формы" -- "ФормаСписка" -- свойства "Список" -- в "Настройка списка" нажать "Открыть" -- вкладка "Отбор"
- нажимаем "Подробно"

![2025-04-01_18-08-04](https://github.com/user-attachments/assets/1d2eefed-59f3-443d-9f7b-427218794f63)

- в поле "Представление" пишем "Невыполненные"
- нажимаем кнопку "Свойства элемента пользовательских настроек", которая рядом с "Подробно"
- устанавливаем флажок "Включать в пользовательские настройки"
- дважды кнопка "ОК" - закрываем все окна

![2025-04-01_18-12-07](https://github.com/user-attachments/assets/8c0a3ec6-3bd0-4841-87a2-e79185d89c19)

- результат:

![2025-04-01_18-15-53](https://github.com/user-attachments/assets/1061c124-be80-449f-8efe-47f59d79b14d)

8. доделываем интерфейс "ДомашниеЗадания"

- все строки списка будут белыми, без выделения их "через одну"
	- свойства элемента формы "Список"
	- "ЧередованиеЦветовСтрок" - сбросить флажок

![2025-04-01_18-49-15](https://github.com/user-attachments/assets/2d230eff-9a6b-45ec-bf36-6dbc3456772e)

- при открытии списка курсор будет всегда на первой строке
	- свойство "НачальноеОтображениеСписка" - "Начало"

![2025-04-02_14-00-26](https://github.com/user-attachments/assets/de91c9b1-a21b-4190-a00a-e19052214f78)

- чтобы список будет открываться со свернутыми группами
	- свойство "НачальноеОтображениеДерева" - "Не раскрывать"

![2025-04-01_18-52-29](https://github.com/user-attachments/assets/6caf1e47-60f8-4479-befe-986f5e3db4f0)

- увидеть все строчки домашнего задания вместо одной строки - надо сделать настройку в 2х местах:

1. "Регистры сведений" -- "ДомашниеЗадания" -- "Ресурсы" -- "ДомашнееЗадание" -- 2 раза по нему щелкнуть -- поставить флажок "Многострочный режим"

![2025-04-02_14-09-16](https://github.com/user-attachments/assets/5bf125cc-6f8b-4db7-a6fb-797283c5a9d4)

2. "Регистры сведений" -- "ДомашниеЗадания" -- "Формы" -- "ФормаСписка" -- 2 раза щелкнуть по элементу формы "ДомашнееЗадание" -- поставить флажок "АвтоВысотаЯчейки"

![2025-04-02_14-12-30](https://github.com/user-attachments/assets/a8637630-68c5-4c3d-8571-e1fa565498e1)

3. результат:

![2025-04-02_14-13-53](https://github.com/user-attachments/assets/c233a2da-c5ef-47e3-a55c-f07ee42ad4e2)


https://github.com/user-attachments/assets/8537b73d-490a-4193-ab91-be01c0b0c6ed

9. отображение "Планировщик" на начальной странице "Дневник"

- два раза щелкнуть по "Дневник"
- в "Рабочая область начальной страницы" нажать "Открыть"
- в поле "Правая колонка" нажать зеленый плюс "Добавить"
- раскрыть список "Общие", потом "Общие формы" и выделить "Планировщик"
- нажать кнопку "ОК"

![2025-04-02_14-26-06](https://github.com/user-attachments/assets/988081c5-a93d-4a81-85f0-faa578b20637)

- выделить в поле "Правая колонка" - "Документ.УчебныйДень..." и нажать красный крестик "Удалить"

![2025-04-02_14-27-07](https://github.com/user-attachments/assets/d20534dc-0314-4456-94fe-be6c05e98fe4)
![2025-04-02_14-28-12](https://github.com/user-attachments/assets/2c0162e5-f060-4007-a197-4d5f4e7f1ac8)

- результат:

![2025-04-02_14-39-12](https://github.com/user-attachments/assets/cf417cbd-4298-49fd-a1ee-5ca72f46fd6c)

10. убираем "Планировщик" из других мест в дневнике

- "Дневник" -- 2 раза щелкаем по нему -- в "Командный интерфейс основного раздела" нажимаем "Открыть" -- "Панель действий.Сервис" -- снимаем флажок у "Планировщик"

![2025-04-02_14-47-15](https://github.com/user-attachments/assets/9c9a9158-155b-4b95-b29b-67e123f5ef62)


11. наводим порядок в "Дневник"

- "Дневник" -- 2 раза щелкаем по нему -- в "Командный интерфейс основного раздела" нажимаем "Открыть" -- "Предметы" из "Панель навигации.Важное (ручной порядок)" перетаскиваем в "Панель навигации.Обычное (ручной порядок)"

![2025-04-02_14-51-16](https://github.com/user-attachments/assets/5b29a504-ee5e-4bfd-af74-d55aa3f3ffeb)
![2025-04-02_14-52-13](https://github.com/user-attachments/assets/3509f9d1-b0f3-45ba-a019-cc4c82dcbdf0)

- "Дневник" -- 2 раза щелкаем по нему -- в "Командный интерфейс основного раздела" нажимаем "Открыть" -- "Домашние задания" и "Учебные дни" из "Панель навигации.Обычное (ручной порядок)" перетаскиваем в "Панель навигации.Важное (ручной порядок)"

![2025-04-02_14-55-01](https://github.com/user-attachments/assets/57df2773-9821-4ffb-ab4c-13cce4527258)
![2025-04-02_14-57-57](https://github.com/user-attachments/assets/04c99748-654f-4a1b-b3e8-8acad68248d4)

- результат:

![2025-04-02_15-00-06](https://github.com/user-attachments/assets/2c918f27-509b-41b3-b8cd-dff4d54c99c3)
